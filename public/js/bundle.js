...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoid2l6YXJkY29kaW5nIiwiYSI6ImNrYXh6ejVzMDBiN3UyeG5pZHV3ZDl1eGUifQ.3yx5c45P8A1cmOSyycXugQ';
  var map = new mapboxgl.Map({
    container: 'map',
    // container set to map means it will set (map) to an element of id map
    style: 'mapbox://styles/wizardcoding/ckay05eo10yow1hquhsidgsgy',
    scrollZoom: false //   center: [-118.113491, 34.111745], // first long then lat
    //   zoom: 4,
    //   interactive: false, // it will stop scrolling the map

  });
  var bounds = new mapboxgl.LngLatBounds(); // LatLngBounds(); this will show the location
...
var stripe = Stripe('pk_test_51GqCetK2Ko8I4rWHZ9myiT4SAC8WUjx5AfCQ04GHKoNAkZsheVWA0OYpkIkKjSkT8i23kGmxs84zM6W0cweFS4WS00uDzIgUeH'); // this tourId will be taken from tour.pug
...
var bookBtn = document.getElementById('book-tour'); // getting element from tour.pug map id data-locations value ( data attribute will be in dataset property)
// and converting strings to json
// DELEGATION
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); // for file(image)
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    // e.target is basically the element that is clicked
